...
public class TargetLuna : MonoBehaviour
{
    ...
    [SerializeField] private Sprite alternateSprite; // Nuevo sprite para cuando la salud sea la mitad o menos
    ...
    public void TakeDamage(int damage)
    {
        ...
        if (health <= maxHealth / 2 && alternateSprite != null)
        {
            spriteRenderer.sprite = alternateSprite; // Cambio de sprite cuando la salud es la mitad o menos
        }
